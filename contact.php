...
<head>
    ...
    <title>Contact Page - Online Courses & Education Bootstrap5 Template</title>
...
<body class="rbt-header-sticky">
                                            ...
                                            <div class="row row--15">
                                                <div class="col-lg-12 col-xl-6 col-xxl-6 single-mega-item">
                                                    ...
                                                    <ul class="mega-menu-item">
                                                        <li><a href="ac-services.html">Filter One Toggle</a></li>
                                                ...
                                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                                    <div class="mega-category-item">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="assets/images/services/category-2.png" alt="Course images"></div>
                                                                <a href="ac-services.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="assets/images/services/category-1.png" alt="Course images"></div>
                                                                <a href="ac-services.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="assets/images/services/category-4.png" alt="Course images"></div>
                                                                <a href="ac-services.html">
                                                        ...
                                                        <div class="nav-category-item">
                                                            <div class="thumbnail">
                                                                <div class="image"><img src="assets/images/services/category-9.png" alt="Course images"></div>
                                                                <a href="ac-services.html">
                                                                    <span>Academy</span>
                                                                    <i class="feather-chevron-right"></i>
                                                                </a>
                    ...
                    <div class="row g-4 pt--30 pb--60">
                            ...
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="assets/images/services/course-online-01.jpg" alt="Card image">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="assets/images/services/course-online-02.jpg" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="assets/images/services/course-online-03.jpg" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.html">
                                        <img src="assets/images/services/course-online-04.jpg" alt="Card image">
                                    </a>
                                </div>
                                <div class="rbt-card-body">
                                    <h5 class="rbt-card-title"><a href="course-details.html">Web Design</a>
    ...
    <div class="rbt-contact-address mt-100">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12">
                    <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                        <div class="section-title text-start">
                            <span class="subtitle bg-primary-opacity">Send Your Requirement</span>
                        </div>
        ...
        if (isset($_GET['service'])) {
            ...
            if ($service === 'ac_services') {
                echo '<h3 class="title">Book AC Service </h3>';
            } elseif ($service === 'balloon_decoration') {
                echo '<iframe width="100%" height="560" src="https://crm.galaxyservices.in/forms/wtl/20dd7a773592bdaa65ac5161ae28877f" frameborder="0" sandbox="allow-top-navigation allow-forms allow-same-origin allow-popups" allowfullscreen></iframe>';
            } elseif ($service === 'cleaning_services') {
                echo '<iframe src="service3_contact_form.php"></iframe>';
            } elseif ($service === 'carpenter_service') {
                echo '<iframe src="service3_contact_form.php"></iframe>';
            } elseif ($service === 'packers_and_movers_pune') {
                echo '<iframe src="service3_contact_form.php"></iframe>';
            } elseif ($service === 'storage_services') {
                echo '<iframe src="service3_contact_form.php"></iframe>';
            }
        }
        ?>
                        ...
                        <ul>
        <!-- <li><a href="contact_page.php?service=1">Service 1</a></li>
        <li><a href="contact_page.php?service=2">Service 2</a></li>
        <li><a href="contact_page.php?service=3">Service 3</a></li> -->
    </ul>
    ...
    <div>
        ...
        if (isset($_GET['service'])) {
            ...
            if ($service === 'AC Service') {
                echo '<iframe width="100%" height="560" src="https://crm.galaxyservices.in/forms/wtl/7a9b9f2d6b79f7c9afd75b145c2dce09" frameborder="0" sandbox="allow-top-navigation allow-forms allow-same-origin allow-popups" allowfullscreen></iframe>';
            } elseif ($service === 'balloon_decoration') {
                echo '<iframe width="100%" height="560" src="https://crm.galaxyservices.in/forms/wtl/20dd7a773592bdaa65ac5161ae28877f" frameborder="0" sandbox="allow-top-navigation allow-forms allow-same-origin allow-popups" allowfullscreen></iframe>';
            } elseif ($service === 'cleaning_services') {
                echo '<iframe src="service3_contact_form.php"></iframe>';
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget">
                            ...
                            <ul class="ft-link">
                                ...
                                <li>
                                    <a href="ac-services.html">Course</a>
                                </li>
                                <li>
